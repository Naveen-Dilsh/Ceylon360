...
class _HomePageState extends State<HomePage> {
  ...
  // Move _launchURL function inside the class
  ...
  String getLocalImagePath(String destinationName) {
    final Map<String, String> imageMap = {
      'Mirissa': 'assets/images/journey/mirissa.jpg',
      'Sigiriya': 'assets/images/journey/sigiriya.jpg',
      'Arugam Bay': 'assets/images/journey/Bay.jpg',
      'Ella': 'assets/images/journey/ella.jpg',
      'Kandy': 'assets/images/journey/kandy.jpg',
    };

    return imageMap[destinationName] ?? 'assets/images/journey/Bay.jpg';
  }
              ...
              child: Container(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    // Category icons - Fixed the duplicate flights icon issue
                    Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: _buildNavItem(Icons.hotel, 'Hotels', false),
            ),
            GestureDetector(
              onTap: () {
                Navigator.push(
